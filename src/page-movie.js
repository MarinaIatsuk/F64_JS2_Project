...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch(
        `https://kinopoiskapiunofficial.tech/api/v2.2/films/${selectedFilmId}`,
        {
            method: "GET",
            headers: {
        ...
        .then((json) => {
            ...
            let ratingAgeLimit = document.querySelector(
                ".block-movie__rating-age-limit"
            );
            let ratingKinopoisk = document.querySelector(
                ".block-movie__rating-kinopoisk"
            );
    ...
    fetch(
        `https://kinopoiskapiunofficial.tech/api/v1/staff?filmId=${selectedFilmId}`,
        {
            method: "GET",
            headers: {
                // 'X-API-KEY': '94ca834b-5c22-427c-af84-610eb7685d60', //tech
    ...
    fetch(
        `https://kinopoiskapiunofficial.tech/api/v2.2/films/${selectedFilmId}/similars`,
        {
            method: "GET",
            headers: {
                // 'X-API-KEY': '94ca834b-5c22-427c-af84-610eb7685d60', //tech
        ...
        .then((json) => {
            if (json.items.length !== 0) {
                const parentElement =
                    document.getElementById("posters-contanier");
